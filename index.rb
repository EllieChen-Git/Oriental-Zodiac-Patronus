...
sleep(1)
puts
puts "Please select your options here (0: Exit the app, 1: Find out your zodiac animal, 2: Find out your animal compatibility, 3: \"Tai Sui\" Test)"
...
#[Option 1 - What is your zodiac animal?]
    ...
    your_zodiac_animals = gets.chomp
        ...
        puts "If you want to continue playing, Please select from 1, 2, 3. Otherwise, press 0."  
        option = gets.chomp
