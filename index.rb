...
index = (birth_year % 12)
puts "And your birth animal is... #{birth_animals[index]}!"
puts
index_2 = index + 4
if index_2 > 10
    index_2 = index_2 -12
...
index_3 = index_2 + 4
puts "Now you know what your birth animal is... Let\'s Find out your zodiac animals compatibility!"
...
puts "You can also enter your birth animal here to know what birth animal has a direct conflict with you!"
your_birth_animal = gets.chomp
puts "Oh, no! As a #{your_birth_animal}, you don\'t get along with #{birth_animals[index_4]}."
